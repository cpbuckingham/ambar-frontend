...
class Search extends Component {
  ...
  componentDidMount() {
      ...
      setAppHeader({
          left: () => < Desktop > {
            localization.searchPage.pageTitle
          } < /Desktop>,
          center: (state) => {
            return ( <
              ...
              (matches) => {
                return ( < div style = {
                    ...
                    /> {
                      ...
                      onScrollDown = {
                        (isFirstPage) => setScrolledDown(!isFirstPage)
                      }
                      />} <
                      /div>)
                    }
                ...
                className = {
                    scrolledDown ? '' : 'hiddenWithAnimation'
                  } >
                  <
                  ArrowUpward / >
                  <
