            ...
            <TableRow>
                ...
                <TableRowColumn style={{ width: '220px' }}>
                    <IconButton onTouchTap={() => { window.open(downloadUri) }}
                        title='Download File'>
                        <FileDownloadIcon color='#607D8B' hoverColor='#80deea' />
                    </IconButton>
                    <IconButton
                        ...
                        title='Text Preview'
                    >
                        <TextPreviewIcon color='#607D8B' hoverColor='#80deea' />
                    </IconButton>
                    <IconButton
